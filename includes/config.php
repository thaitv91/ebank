...
if (TARGET_PLATFORM == FILE_SYSTEM_PLATFORM)
{
 	...
 	*/ 
	define("FILE_ROOT", "http://192.168.1.101/server1/Escom Club/business_new"); 
}
else if (TARGET_PLATFORM == DATABASE_PLATFORM)
{
	...
	$dbPassword = "mahendra123";
	//set database name
	$dbName = "superdeal_business";
...
define ("FAILED", "Plz Configure Properly");  // Don't edit
