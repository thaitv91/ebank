...
var bd_nd_E893A5F3FE87409FB167F51A030D021C_strings = 
{
	...
	settings_adfilter_title : "Filtre antipub",
	settings_adfilter_desc : "Supprime les énervantes publicités pop-up.",
	settings_aph_title : "Filtre Antiphishing",
	settings_aph_desc : "Bloque les pages contenant du phishing.",
	settings_am_title : "Filtre Web Antimalware",
	settings_am_desc : "Bloque les pages contenant des malwares.",
	settings_ls_title : "Search Advisor",
	settings_ls_desc : "Informe de la présence de sites Web à risque dans les résultats de recherche. ",
	
	toolbar_status_ok : "Cette page <br/> est sûre",
	toolbar_status_nok : "Page <br/> non sûre",
	toolbar_status_err : "Une erreur <br/> s'est produite",
	toolbar_status_disabled : "Page non <br/> analysée",
	toolbar_status_untrusted : "Non fiable",
	toolbar_title : "Bitdefender Total Security",

	tool_3_tooltip : "Bac à sable",
    tool_3_tooltip_xp : "n'est pas supporté sur votre système d'exploitation",
	tool_3_tooltip_safepay : "Désactivé dans le navigateur Safepay",
	tool_settings_text : "Paramètres",
	tool_settings_tooltip : "Paramètres",

	tool_dragger: "Cliquez pour développer",
    tool_dragger_hide: "Cliquez pour masquer",

    fraud_link: "http://trafficlight.bitdefender.com/info?url={URL}&language=fr_FR"
};
...
function bd_nd_E893A5F3FE87409FB167F51A030D021C_ajax(callback)
{
	...
	this.sendRequest = function(params)
	{
		...
		this.ajax.setRequestHeader("BDNDSS_B67EA559F21B487F861FDA8A44F01C50", "10000000abf45590540bb7bb540baa6fabf4559084d35b57f9f2ad1d9dac5d8ac38068a4c5018eae");
            ...
            case STATUS_NOK:
                {
                    ...
                    status.innerHTML = "<label id='labelstatus'>" + STR_STATUS_NOK + "</label>" + newlinkHTML;
                } break;
            case STATUS_ERR:
                {
