								...
								while($rrr = mysql_fetch_array($qqq))
								{
									...
									if($investment_user_id != $pay_user_id){
										...
										if(real_parent($investment_user_id) == $pay_user_id || real_parent($pay_user_id)  == $investment_user_id)
										{
											...
											$title = 'You have a new matched PH-GH';
											$contentmail = 'Your PH request has been successfully processed. Please log-in to <a href="https://system.ebank.tv/login.php">www.eBank.tv</a> now to complete the PH.';
	...
	{ 
		...
		<tr>
			<th>
				...
				<font color=dark>$ </font> <?//=$total_investment_amount_snd; ?>
