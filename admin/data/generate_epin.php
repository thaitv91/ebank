...
if(isset($_POST['submit']))
{
	...
	else
	{
	   ...
	   //         			 $content = $epin_number.' e-PINs have been added to your eBank account. Please log in to do a PH to help the community.';
	   //          			sendMail($email,$name,$title,$content);
				...
				$to = get_user_email($new_user_id);
				$title = $epin_number.' e-PINs have been added to your account.';
				$contentmail = $epin_number.' e-PINs have been added to your eBank account. Please log in to do a PH to help the community.';
