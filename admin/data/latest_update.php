...
<tr>
  ...
  <tr>
    ...
    <td class=\"input-small\" align=\"center\"><small>$total_income  <font color=dark>$ </font></small></td>
  </tr>
  <tr>
    <td class=\"input-small\" align=\"center\">Total Funds Added</td>
    <td class=\"input-small\" align=\"center\"><small>$get_total_fund_added  <font color=dark>$ </font></small></td>
  </tr>
  <tr>
    <td class=\"input-small\" align=\"center\">Total Amount Paid</td>
    <td class=\"input-small\" align=\"center\"><small>$total_amnt_paid  <font color=dark>$ </font></small></td>
  </tr>
  <tr>
    <td class=\"input-small\" align=\"center\">Total Amount Unpaid</td>
    <td class=\"input-small\" align=\"center\"><small>$total_amnt_unpaid  <font color=dark>$ </font></small></td>
  </tr>
  <tr>
    <td class=\"input-small\" align=\"center\">Total Amount in Wallet</td>
    <td class=\"input-small\" align=\"center\"><small>$total_wallet_amnt  <font color=dark>$ </font></small></td>
  </tr>
</table></div></div>
</td>
...
<td class=\"input-small\" align=\"center\"><small>$latest_joining_income  <font color=dark>$ </font></small></td></tr>
<tr>
    <td class=\"input-small\" align=\"center\">Total Funds Added</td>
    <td class=\"input-small\" align=\"center\"><small>$get_total_lestest_fund_added  <font color=dark>$ </font></small></td>
  </tr>
<tr><td class=\"input-small\" align=\"center\">Total Amount Paid</td>
<td class=\"input-small\" align=\"center\"><small>$total_latest_amnt_paid  <font color=dark>$ </font></small></td></tr>
<tr><td class=\"input-small\" align=\"center\">Total Amount Unpaid</td>
<td class=\"input-small\" align=\"center\"><small>$total_latest_amnt_unpaid  <font color=dark>$ </font></small></td></tr>
<tr><td class=\"input-small\" align=\"center\">Total Amount in Wallet</td>
<td class=\"input-small\" align=\"center\"><small>$total_latest_wallet_amnt  <font color=dark>$ </font></small></td></tr>
</table>
</div></div>
</td></tr>
<tr><td colspan=2>
...
<td class=\"input-small\" align=\"center\">Date</td>
  ...
  $query = mysql_query("select * from logs where user_id != 0 group by id desc limit 50 ");
...
{
	$amount = mysql_query("select * from reg_fees_structure ");
	$total_income = 0;
...
{
	$amount = mysql_query("select * from paid_unpaid where 	paid = 1 ");
	$total_amnt_paid = 0;
	while($row = mysql_fetch_array($amount))
	{
...
{
	$amount = mysql_query("select * from paid_unpaid where 	paid = 0 ");
	$total_amnt_unpaid = 0;
	while($row = mysql_fetch_array($amount))
	{
...
{
$amount = mysql_query("select * from wallet ");
	$total_wallet_amnt = 0;
	while($row = mysql_fetch_array($amount))
	{
...
{
$amount = mysql_query("select * from add_funds where mode = 1 ");
	$total_fund = 0;
	while($row = mysql_fetch_array($amount))
	{
...
{
	$date = date('Y-m-d');
	$amount = mysql_query("select * from reg_fees_structure where date = '$date' ");
	$total_income = 0;
	while($row = mysql_fetch_array($amount))
	{
		$total_income = $total_income+$row['update_fees'];
