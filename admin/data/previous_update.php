...
$query = mysql_query("select * from logs where user_id != 0 group by id desc ");
...
$pnums = ceil ($totalrows/$plimit);
  ...
  $query = mysql_query("select * from logs where user_id != 0 group by id desc LIMIT $start,$plimit ");
