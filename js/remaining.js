...
var remaining2 = {
	...
	*/
	getString2: function(seconds, i18n, onlyLargestUnit, hideEmpty) {
		if (seconds < 1) {
			return '';
		}
		...
		for (unit in units) {
			...
			if (seconds / value >= 1 || unit == 'seconds' || !hideEmpty) {
				...
				returnArray.push('<span class="col-hour"><span class="number_hour">'+secondsConverted + '</span><span class="text_hour">' + i18nUnit+'</span></span>');
