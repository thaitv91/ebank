...
if($_POST['update'])
{
	...
	if($validator->ValidateForm())
    {
		...
		$insert_q = mysql_query("UPDATE users SET f_name = '$f_name', l_name = '$l_name', gender = '$gender', dob = '$dob', email = '$email', phone_no = '$phone_no', city = '$city', country = '$country', provience = '$provience', address = '$address' , password = '$password' WHERE id_user = '$id'");
