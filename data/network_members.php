<?php
	...
	for($i=1 ; $i <= $cnt; $i++)
	{
		do
		{
			...
			$id_query = mysql_query("SELECT * FROM users WHERE real_parent = '$bbid' ");
...
<table width="400" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td width="200" style="background-color:#57904C; color:#FFFFFF; font-weight:bolder; text-align:center; height:30px; vertical-align:middle">Level</td>
    <td style="background-color:#57904C; color:#FFFFFF; font-weight:bolder; text-align:center; height:30px; vertical-align:middle">Member(s)</td>
  </tr>
 <?php 
 ...
 { ?> 
   <tr>
    <td style="background-color:#d8fbd0; color:#002346; font-weight:bolder; text-align:center; height:30px; vertical-align:middle; border-right:#002346 solid 1px; border-bottom:#002346 solid 1px;"><?php print "Level ".($i-1); ?></td>
    <td style="background-color:#d8fbd0; color:#002346; font-weight:bolder; text-align:center; height:30px; vertical-align:middle; border-bottom:#002346 solid 1px;"><?php print $total_lvl_child[$i]; ?></td>
  </tr>
 <?php } ?>  
