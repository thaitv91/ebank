...
if (isset($_POST['submit']))
{
    ...
    else
    {
        ...
        /* $sql_update = "UPDATE users SET f_name = '$f_name',l_name='$l_name',gender='$gender', 
          ...
          bank_code = '$ifsc'"; */
        if( (!empty($_FILES['photo']['name'])) || !empty($idcard) ) {
        ...
        {	
            ...
            else
            {
                ...
                $sql_update .="photo_idcard = '$unique_name'";
            }

            if($idcard) {
	        	$sql_update .=", idcard = '$idcard'";
	        }
        } else {
        	if($idcard) {
	        	$sql_update .="idcard = '$idcard'";
...
<div class="box box-primary" style="padding: 15px"> 
    <form name="money" class="form-horizontal" action="index.php?page=edit-idcard" method="post" enctype="multipart/form-data">
            <div class="row">
				<div class="form-group">
						...
						<div class="col-sm-5">
							...
							<input id="file-upload" type="file"  name="photo" value="<?= $photo_idcard; ?>"/>
							<!--<input class="form-control col-sm-11 col-xs-12" type="file" name="photo" value="<?//= $photo; ?>" />-->
						</div>
					</div>
			</div>
			...
			<div class="col-md-6 col-sm-12">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control col-sm-11 col-xs-12" name="idcard" value="<?= $idcard; ?>" >
					</div>
				</div>
			</div>
