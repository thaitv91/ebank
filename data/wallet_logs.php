...
?>
<h2 align="left">Account History</h2>
...
{
	$title = 'Display';
	$message = 'Display Account History';
	data_logs($user_id,$title,$message,0);
}

$query1 = mysql_query("select * from logs where user_id = '$user_id' and type = '$log_type[4]' ");
...
$query = mysql_query("select * from logs where user_id = '$user_id' and type = '$log_type[4]' LIMIT $start,$plimit ");
