            ...
            if ($chk_all_inv == 0)
            {
                ...
                while ($rowa = mysql_fetch_array($qq))
                {
                    ...
                    if ($rec_mode_inv == 1)
                    {
                        ...
                        //mysql_query("insert into user_income (user_id , income , income_id, date , type, level ) values ('$income_id' , '$income' , '$user_id' ,'$date' , '$income_type[6]','0') ");



                        //get_ten_level_sponsor_income($investment_user_ids, $total_investments, $direct_percent, $systems_date, $level_vtype);
