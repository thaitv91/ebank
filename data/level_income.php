...
$query = mysql_query("select * from user_income where user_id = '$user_id' and type = '$income_type[3]' ");
...
<?php
	...
	print "<tr>
			<td align=\"center\"><strong>Total Level Income</strong></td>
		...
		<td align=\"center\"><strong>Level</strong></td></tr>";
	...
	$query1 = mysql_query("select * from user_income where user_id = '$user_id' and type = '$income_type[3]' LIMIT $start,$plimit ");
	while($row = mysql_fetch_array($query1))
	{
		...
		<td align=\"center\" width=200>Level $level</td></tr>";
		$j = 1;
	}
	print"</tbody></table>";
	...
	if ($newp>1)
	{ 
		?> <li><a href="<?php echo "index.php?page=level_income&p=".($newp-1);?>">&laquo;</a></li> <?php 
	}
	for ($i=1; $i<=$pnums; $i++) 
	{ 
		if ($i!=$newp)
		{ 
			?> <li><a href="<?php echo "index.php?page=level_income&p=$i";?>"><?php print_r("$i");?></a></li> <?php 
		}
		else
		{
	...
	if ($newp<$pnums) 
	{ 
		?> <li><a href="<?php echo "index.php?page=level_income&p=".($newp+1);?>">&raquo;</a></li> <?php 
	} 
}		
