...
<div class="col-md-12">
	<div class="widget">
		<div class="widget-head clearfix">
			<h4 class="heading"><i class="fa fa-upload"></i>  PD Downline</h4>
		</div>
		<div class="widget-body innerAll">
				...
				?>
					<tr><td><?=$i?></td><td><?=$row['username'];?></td>
						<td>
							<form action="index.php?page=downline_pd" method="post">
								<input type="hidden" name="network" value="<?=$row['id_user']?>" />
								<input type="submit" name="pd" value="PD" class="btn btn-success" />
							</form>
						</td>
					</tr>
				<?php 
