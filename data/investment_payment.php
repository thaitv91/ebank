...
else
{
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
		<tr>
			<td colspan="4" ><strong>Total Investment Payment</strong></td>
			<td colspan="6" ><strong><?php print $tamount; ?> <font color=dark>$ </font></strong></td>
		</tr>
	...
	while($r = mysql_fetch_array($q))
	{
		...
		print "<tr>
				...
				<table class="MyTable" border="1" bordercolor="#FFFFFF" style="border-collapse:collapse; margin:6px;" cellpadding="0" cellspacing="0" width="95%" >
					<tr>
						<td align="center" height="25" colspan="2" style="padding-left:0px;" bgcolor="#B8C8DC">
...
<?php		print "</td>
			...
			<td align=\"center\">$bank_acc</td>
			<td align=\"center\">$invst_status</td>
		  </tr>";
	}
	print "<tr><td colspan=10>&nbsp;</td></tr>
		<tr>
		  <td style=\"text-align:left; padding-left:20px;\" colspan=10 height=30px width=400><strong>";
		if ($newp>1)
		{ ?>
