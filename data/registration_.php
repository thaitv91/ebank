                            ...
                            else
                            {
                                ...
                                if ($_POST['username'] != $_POST['real_perent_id'])
                                {
                                    ...
                                    if ($chk_ac_no > 0)
                                    {
                                        ...
                                        $error_ac_no = "<B style=\"color:#FF0000;\">Invalid Account Number</B>";
                                    }
                                    else
                                    {
...
//isset($_REQUEST['verify']) and $_REQUEST['verify'] == 'success' and
        ...
        if ($_SESSION['cdbv_verify_user'] == 1)
        {
            ...
            mysql_query("INSERT INTO users (username,real_parent,level) VALUES ('$username' , '$real_p' , '1') ");
	...
	ac_no = '$ac_no' , bank = '$bank' , branch = '$branch' , bank_code = '$bank_code' ,gender = '$gender' 
	...
	'$code8' , '$code9' , '$code10' , '$date') ");
            ...
            $email = $email;
            $name  = $username;
            $title = "You have just been added to eBank";
            $content = 'An eBank member has just added you to the system. Please log in now, buy e-PINs and make a PH to help the community.';
	...
	secured. www.ebank.tv";
            ...
            echo "window.location = \"index.php?page=registration&success=Yes\"";
